...
# Pinus pinea model (Andalucía, Spain), version 01
# Written by iuFOR
...
class PinusPineaAndalucia(TreeModel):
    ...
    def __init__(self, configuration=None):
        super().__init__(name="Pinus pinea - Andalucía", version=1)
    ...
    def initialize(self, plot: Plot):
        ...
        print('#----------------------------------------------------------------------------#')
        print('                Pinus pinea model (West Andalucía) is running                 ')
        print('#----------------------------------------------------------------------------#')
    ...
    def merch_classes(self, tree: Tree):
        ...
        usage, merch_list = TreeModel.merch_calculation(tree, class_conditions, PinusPineaAndalucia)
